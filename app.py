...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="Video Game RAG Assistant",
    page_icon="🎮",
    layout="wide"
)
...
with st.sidebar:
    ...
    st.markdown("""
    ### About
    This RAG assistant answers questions about video games using:
    - Player reviews and community discussions from gaming forums
    - Factual information about games, genres, and releases
    - Semantic search over embedded video game data
    """)

# -----------------------------------------------------------------------------
# Main App Header
# -----------------------------------------------------------------------------
st.title("🎮 Video Game RAG Assistant")
st.markdown("Ask questions about the video games and get AI-powered answers based on curated content.")
...
with st.expander("💡 Example Questions"):
    examples = [
        "Give me the top 5 video games right now.",
        "What video games are most recommended by players?",
        "Tell me about The Legend of Zelda.",
        "What makes a video game critically acclaimed?",
        "What are common complaints players have about modern games?"
    ]
